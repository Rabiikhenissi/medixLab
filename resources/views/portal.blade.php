<x-layouts.auth>
    ...
    <div class="flex flex-col items-center justify-center w-full py-10">
        <!-- Main Headings -->
        <h1 class="text-4xl md:text-5xl font-extrabold text-center tracking-tight text-[#1e293b] max-w-2xl leading-tight mb-4 select-none">
        ...
        <div class="flex flex-col lg:flex-row items-stretch justify-center gap-8 w-full max-w-5xl px-4">
            ...
            <x-portal-card
                ...
                registerUrl="{{ route('doctor.register') }}"
                loginText="Doctor Login"
            >
                <svg class="w-8 h-8 text-[#0066FF]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <x-portal-card
                ...
                registerUrl="{{ route('patient.register') }}"
                loginText="Patient Login"
            >
                <svg class="w-8 h-8 text-[#0D9488]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <x-portal-card
                ...
                registerUrl="{{ route('center.register') }}"
                loginText="Center Login"
            >
                <svg class="w-8 h-8 text-[#7C3AED]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
