...
@section('title', __('admin.groups.add_title'))

@section('page-title', __('admin.groups.create_title'))
@section('page-subtitle', __('admin.groups.create_subtitle'))
...
<form action="{{ route('admin.groups.store') }}" method="POST" id="group-form">
    @csrf
        ...
        <div class="data-section group-form-card">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" value="{{ old('name') }}" required
                    ...
                    id="role-name" oninput="updateSummary()">
            </div>
            ...
            <div class="form-group" style="margin-bottom: 0;">
                ...
                <div class="code-input-wrap">
                    ...
                    <input type="text" name="code" value="{{ old('code') }}" required
                        ...
                        id="role-code" oninput="updateSummary()">
                </div>
