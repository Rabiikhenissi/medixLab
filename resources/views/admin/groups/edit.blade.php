        ...
        <form action="{{ route('admin.groups.update', $group) }}" method="POST">
            ...
            <div class="form-row" style="margin-bottom: 24px;">
                <div class="form-group">
                    ...
                    <input type="text" name="name" value="{{ old('name', $group->name) }}" required placeholder="Ex: Directeur de Laboratoire" class="form-control">
                </div>
                <div class="form-group">
                    <label class="form-label">Code de sécurité (Unique)<span class="required-star">*</span></label>
                    <input type="text" name="code" value="{{ old('code', $group->code) }}" required placeholder="Ex: directeur-labo" class="form-control" style="font-family:'SF Mono','Consolas',monospace;font-weight:600;letter-spacing:0.5px;">
                </div>
            </div>
