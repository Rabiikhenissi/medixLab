...
@section('page-title', __('admin.users.create_title'))
@section('page-subtitle', __('admin.users.create_subtitle'))
        ...
        <form action="{{ route('admin.users.store') }}" method="POST">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="first_name" value="{{ old('first_name') }}" required placeholder="{{ __('admin.users.first_name_placeholder') }}" class="form-control">
                </div>
                <div class="form-group">
                    <label class="form-label">{{ __('auth.last_name') }}<span class="required-star">*</span></label>
                    <input type="text" name="last_name" value="{{ old('last_name') }}" required placeholder="{{ __('admin.users.last_name_placeholder') }}" class="form-control">
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="phone" value="{{ old('phone') }}" placeholder="{{ __('admin.users.phone_placeholder') }}" class="form-control">
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="address" value="{{ old('address') }}" placeholder="{{ __('admin.users.address_placeholder') }}" class="form-control">
                </div>
            </div>
            ...
            <div class="form-row" style="margin-bottom: 24px;">
                <div class="form-group">
                    <label class="form-label">{{ __('admin.users.password_label') }}<span class="required-star">*</span></label>
                    <div class="pw-input-wrap" style="position:relative;">
                        <input type="password" name="password" id="pw1" required placeholder="{{ __('admin.users.password_placeholder') }}" class="form-control" style="padding-right: 42px;">
                ...
                <div class="form-group">
                    <label class="form-label">{{ __('admin.users.confirm_password') }}<span class="required-star">*</span></label>
                    <div class="pw-input-wrap" style="position:relative;">
                        <input type="password" name="password_confirmation" id="pw2" required placeholder="{{ __('admin.users.confirm_password_placeholder') }}" class="form-control" style="padding-right: 42px;">
                        <button type="button" tabindex="-1" onclick="togglePw(this)" style="position:absolute;right:10px;top:50%;transform:translateY(-50%);background:none;border:none;cursor:pointer;color:#94a3b8;padding:4px;display:flex;align-items:center;justify-content:center;border-radius:6px;">
                            <svg class="pw-eye" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z"/>
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
            ...
            <div style="display: flex; justify-content: flex-end; gap: 12px; border-top: 1px solid #f1f5f9; padding-top: 24px; margin-top: 24px;">
                ...
                <button type="submit" class="btn-submit">{{ __('admin.users.create_button') }}</button>
            </div>
        </form>
    </div>
@endsection
