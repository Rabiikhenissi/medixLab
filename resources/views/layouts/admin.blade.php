...
<head>
    ...
    <title>@yield('title', __('layouts.admin.default_title')) - Medix eSanté</title>
    ...
    <div class="layout">
        ...
        <div class="page-content">
            ...
            <div class="flex items-center gap-2 text-[10px] uppercase tracking-wider font-extrabold text-[#64748b] bg-[#f8fafc]/40 px-4 py-2.5 rounded-xl border border-[#e2e8f0]/40 mb-6 select-none">
                <a href="{{ route('admin.dashboard') }}" class="hover:text-[#0066ff] transition">{{ __('layouts.admin.admin_space') }}</a>
                ...
                @if($adminRoute === 'admin.dashboard')
                    <span class="text-[#1e293b]">{{ __('layouts.admin.dashboard') }}</span>
                @elseif($adminRoute === 'admin.users.index')
                    <span class="text-[#1e293b]">{{ __('layouts.admin.users') }}</span>
                @elseif($adminRoute === 'admin.laboratories.index')
                    <span class="text-[#1e293b]">{{ __('layouts.admin.establishments') }}</span>
                @elseif($adminRoute === 'admin.exams.index')
                    <span class="text-[#1e293b]">{{ __('layouts.admin.exams') }}</span>
                @elseif($adminRoute === 'admin.available-exams.index')
                    <a href="{{ route('admin.exams.index') }}" class="hover:text-[#0066ff] transition">{{ __('layouts.admin.exams') }}</a>
                    <svg class="w-3 h-3 text-[#94a3b8]" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5"/></svg>
                    <span class="text-[#1e293b]">{{ __('layouts.admin.available_exams') }}</span>
